...
# Start coolwsd
exec /usr/bin/coolwsd --version --o:sys_template_path=/opt/cool/systemplate --o:child_root_path=/opt/cool/child-roots-alt --o:file_server_root_path=/usr/share/coolwsd --o:logging.color=false ${extra_params}
